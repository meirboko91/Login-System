...
def is_valid_password(password):
    ...
    req = load_user_create_requierments("CommunicationLTD/password_requirements.json")
...
def passwordNotInLasts(user, new_password):
    policy = load_user_create_requierments("CommunicationLTD/password_requirements.json")
